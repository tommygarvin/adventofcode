...
func part2() {
	...
	for scanner.Scan() {
		...
		cubePower := calculatePower(cubeHighestRed, cubeHighestGreen, cubeHighestBlue)
		total += cubePower
	}
...
func calculatePower(cubeHighestRed int, cubeHighestGreen int, cubeHighestBlue int) int {
	power := cubeHighestRed * cubeHighestGreen * cubeHighestBlue
	return power
}
