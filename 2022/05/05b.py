...
def move_crane(pattern):            # function to move the crane
    ...
    claw = stacks[source][-count:]  # claw picks up count mount of crates
    del stacks[source][-count:]     # delete same amount of crats from source
    stacks[destination] += claw     # add those crates to destination
